...
class CallSessionService:
    ...
    def get_by_customer_id(self, customer_id: str) -> List[CallSession]:
        return self.db.query(CallSession).filter(CallSession.cust_id == customer_id).all()
    ...
    def update(self, call_session_id: int, call_session_data: CallSessionUpdate) -> Optional[CallSession]:
