  ...
  <div>
    ...
    <div class="d-flex ga-2 my-10 align-center">
      ...
      <v-btn
        ...
        :disabled="
          callStore.audioQueue.length === 0 && !callStore.isPlayingAudio
        "
    ...
    <div class="bg-grey pa-2 rounded-lg mb-4">
      <div class="d-flex align-center ga-2 mb-2 text-black">
        ...
        <span
          v-if="callStore.isInCall && callStore.startTime"
          class="text-body-2"
        >
    ...
    <div class="bg-grey pa-2 rounded-lg">
      ...
      <div v-if="callStore.audioQueue.length > 0" class="queue-preview">
        ...
        <div class="mt-1">
          <div
            v-for="(item, index) in callStore.audioQueue.slice(0, 3)"
            :key="item.id"
          ...
          <div
            v-if="callStore.audioQueue.length > 3"
